...
QT_MOC_LITERAL(3, 28, 17), // "tableContextClick"
QT_MOC_LITERAL(4, 46, 3), // "pos"
QT_MOC_LITERAL(5, 50, 17), // "onStudentEditCall"
QT_MOC_LITERAL(6, 68, 24) // "on_addstudentBtn_clicked"

    },
    "StudentDisplay\0closeSignal\0\0"
    "tableContextClick\0pos\0onStudentEditCall\0"
    "on_addstudentBtn_clicked"
};
...
void StudentDisplay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->tableContextClick((*reinterpret_cast< const QPoint(*)>(_a[1]))); break;
        case 2: _t->onStudentEditCall(); break;
        case 3: _t->on_addstudentBtn_clicked(); break;
        default: ;
        }
        ...
        {
            typedef void (StudentDisplay::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StudentDisplay::closeSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void StudentDisplay::closeSignal()
{
